/* INSERT INTO testing_testtable (testnumber) VALUES (1) */
/*
...
/*Table structure for table `testing_customers` */

DROP TABLE IF EXISTS `testing_customers`;

CREATE TABLE `testing_customers` (
...
/*Data for the table `testing_customers` */

INSERT  INTO `testing_customers`(`id`,`customertypeid`,`name`,`address`,`city`,`state`,`postalcode`,`buyer`,`createdby`,`createdon`,`changedby`,`changedon`,`active`) VALUES 
...
/*Table structure for table `testing_customertypes` */

DROP TABLE IF EXISTS `testing_customertypes`;

CREATE TABLE `testing_customertypes` (
  `id` INT(11) NOT NULL,
...
/*Data for the table `testing_customertypes` */

INSERT  INTO `testing_customertypes`(`id`,`typedescription`,`discount`,`createdby`,`createdon`,`changedby`,`changedon`) VALUES 
...
/*Table structure for table `testing_examples` */

DROP TABLE IF EXISTS `testing_examples`;

CREATE TABLE `testing_examples` (
  `id` INT(11) NOT NULL AUTO_INCREMENT,
  `name` VARCHAR(50) NOT NULL,
...
/*Data for the table `testing_examples` */

INSERT  INTO `testing_examples`(`id`,`name`,`isbn`,`authors`,`createdby`,`createdon`,`changedby`,`changedon`,`price`) VALUES 
...
/*Table structure for table `testing_invoicelineitems` */

DROP TABLE IF EXISTS `testing_invoicelineitems`;

CREATE TABLE `testing_invoicelineitems` (
  `id` INT(11) NOT NULL AUTO_INCREMENT,
...
/*Data for the table `testing_invoicelineitems` */

/*Table structure for table `testing_invoices` */

DROP TABLE IF EXISTS `testing_invoices`;

CREATE TABLE `testing_invoices` (
  `id` INT(11) NOT NULL AUTO_INCREMENT,
...
/*Data for the table `testing_invoices` */

/*Table structure for table `testing_orderstatuses` */

DROP TABLE IF EXISTS `testing_orderstatuses`;

CREATE TABLE `testing_orderstatuses` (
  `id` INT(11) NOT NULL,
  `status` VARCHAR(50) NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=MYISAM DEFAULT CHARSET=latin1;

/*Data for the table `testing_orderstatuses` */

INSERT  INTO `testing_orderstatuses`(`id`,`status`) VALUES 
(0,'New'),
(1,'Submitted'),
(2,'Fullfilled'),
(3,'Cancelled');

/*Table structure for table `testing_suppliers` */

DROP TABLE IF EXISTS `testing_suppliers`;

CREATE TABLE `testing_suppliers` (
  `id` INT(11) NOT NULL AUTO_INCREMENT,
...
/*Data for the table `testing_suppliers` */

INSERT  INTO `testing_suppliers`(`id`,`name`,`address`,`city`,`state`,`postalcode`,`createdby`,`createdon`,`changedby`,`changedon`) VALUES 
...
/*Table structure for table `testing_supplier_titles` */

DROP TABLE IF EXISTS `testing_supplier_titles`;

CREATE TABLE `testing_supplier_titles` (
  `id` INT(11) NOT NULL AUTO_INCREMENT,
  `supplierid` INT(11) NOT NULL,
  `titleid` INT(11) NOT NULL,
...
/*Data for the table `testing_supplier_titles` */

INSERT  INTO `testing_supplier_titles`(`id`,`supplierid`,`titleid`,`discountquantity`,`unitprice`,`effectivedate`,`createdby`,`createdon`,`changedby`,`changedon`) VALUES 
...
/*Table structure for table `testing_testtable` */

DROP TABLE IF EXISTS `testing_testtable`;

CREATE TABLE `testing_testtable` (
  `id` INT(11) NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=MYISAM DEFAULT CHARSET=latin1;

/*Data for the table `testing_testtable` */

/*Table structure for table `testing_titles` */

DROP TABLE IF EXISTS `testing_titles`;

CREATE TABLE `testing_titles` (
  `id` INT(11) NOT NULL AUTO_INCREMENT,
  `name` VARCHAR(50) NOT NULL,
  `isbn` VARCHAR(20) NOT NULL,
  `authors` VARCHAR(150) DEFAULT NULL,
...
/*Data for the table `testing_titles` */

INSERT  INTO `testing_titles`(`id`,`name`,`isbn`,`authors`,`createdby`,`createdon`,`changedby`,`changedon`) VALUES 
